package com.bellacorp.licenseapplication.util;
...
public class Logger {
    ...
    static SimpleDateFormat sdf = new SimpleDateFormat("YYYY-MM-dd hh:mm:ssss");
    ...
    public static void writeFile(String data) {
        ...
        try {
            ...
            File folder = new File("/sdcard/kfh_log");
            folder.mkdirs();
            File file = new File("/sdcard/kfh_log/" + filename + ".txt");
            FileOutputStream fileinput = new FileOutputStream(file, true);
            PrintStream printstream = new PrintStream(fileinput);
            printstream.print(sdf.format(new Date(System.currentTimeMillis())) + " " + data + "\n");
            fileinput.close();
        } catch (Exception e) {
            e.toString();
        }
    ...
    public static void mqttWrite(String data) {
        try {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("YYYY-MM-dd");
            String filename = simpleDateFormat.format(new Date(System.currentTimeMillis()));
            File folder = new File("/sdcard/kfh_log");
            folder.mkdirs();
            File file = new File("/sdcard/kfh_log/" + filename + "_mqtt.txt");
            FileOutputStream fileinput = new FileOutputStream(file, true);
            PrintStream printstream = new PrintStream(fileinput);
            printstream.print(sdf.format(new Date(System.currentTimeMillis()))+" "+data + "\n");
            fileinput.close();
    ...
    public static void mqtt(Object str) {
        {
